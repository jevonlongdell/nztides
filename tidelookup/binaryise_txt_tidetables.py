    ...
    for i in [2016,2017,2018]:
        ...
        if i==2016:
            ...
            try:
                ...
                print  "couldn't open datafile for %s,%d, assuming we dont have any more data for %s"%(port,i,port)
